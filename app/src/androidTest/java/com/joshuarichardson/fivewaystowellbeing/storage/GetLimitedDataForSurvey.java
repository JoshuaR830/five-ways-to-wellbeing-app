...
public class GetLimitedDataForSurvey {
    ...
    public void setup() {
        ...
        ActivityRecord activityRecord1 = new ActivityRecord("Activity name 1", 2000, 34625476, ActivityType.SPORT, WaysToWellbeing.BE_ACTIVE, false, 0);
        ActivityRecord activityRecord2 = new ActivityRecord("Activity name 2", 2000, 34625477, ActivityType.SPORT, WaysToWellbeing.BE_ACTIVE, false, 0);
        ActivityRecord activityRecord3 = new ActivityRecord("Activity name 3", 2000, 34625478, ActivityType.SPORT, WaysToWellbeing.BE_ACTIVE, false, 0);
