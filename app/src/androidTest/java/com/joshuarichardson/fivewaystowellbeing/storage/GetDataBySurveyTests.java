...
public class GetDataBySurveyTests {
    ...
    public void setup() {
        ...
        ActivityRecord activityRecord2 = new ActivityRecord("Activity name 2", 2000, 34625476, ActivityType.SPORT, WaysToWellbeing.BE_ACTIVE, false, 0);
        long activityRecordId2 = this.activityRecordDao.insert(activityRecord2);

        ActivityRecord activityRecord3 = new ActivityRecord("Activity name 3", 2000, 34625476, ActivityType.SPORT, WaysToWellbeing.BE_ACTIVE, false, 0);
